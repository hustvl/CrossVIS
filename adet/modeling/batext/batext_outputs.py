...
from adet.utils.comm import compute_ious, get_world_size, reduce_sum
...
class BATextOutputs(object):
    ...
    def compute_targets_for_locations(self, locations, targets, size_ranges):
        ...
        for im_i in range(len(targets)):
            ...
            if bboxes.numel() == 0:
                ...
                bezier_targets.append(
                    locations.new_zeros((locations.size(0), 16)))
                continue
    ...
    def predict_proposals(self, top_feats):
        ...
        for i, instance in enumerate(zip(*bundle.values())):
            ...
            t = instance_dict['t'] * instance_dict[
                's'] if 't' in bundle else None

            sampled_boxes.append(
                self.forward_for_single_feature_map(l, o, r, c,
                                                    self.image_sizes, t))
    ...
    def forward_for_single_feature_map(self,
        ...
        for i in range(N):
            ...
            if top_feat is not None:
                ...
                # decentralize
                bezier_detections = per_locations.unsqueeze(
                    1) + per_top_feat.view(-1, 8, 2)
