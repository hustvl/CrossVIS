...
class FCOSOutputs(nn.Module):
    ...
    def losses(self,
               ...
               top_feats=None,
               reid_feats=None):
        """Return the losses from a set of FCOS predictions and their
    ...
    def predict_proposals(self,
        ...
        for i, per_bundle in enumerate(zip(*bundle.values())):
            ...
            re = per_bundle['re'] if 're' in bundle else None
    ...
    def forward_for_single_feature_map(self,
        ...
        if reid_feat is not None:
            reid_feat = reid_feat.view(N, -1, H, W).permute(0, 2, 3, 1)
            reid_feat = reid_feat.reshape(N, H * W, -1)
        ...
        for i in range(N):
            ...
            if reid_feat is not None:
                per_reid_feat = reid_feat[i]
                per_reid_feat = per_reid_feat[per_box_loc]
            ...
            if per_candidate_inds.sum().item() > per_pre_nms_top_n.item():
                ...
                if reid_feat is not None:
                    per_reid_feat = per_reid_feat[top_k_indices]
            ...
            if reid_feat is not None:
                boxlist.reid_feat = per_reid_feat
