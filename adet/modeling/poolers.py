...
def assign_boxes_to_levels_by_metric(box_lists,
                                     min_level,
                                     max_level,
                                     canonical_box_size,
                                     canonical_level,
                                     metric_fn=_box_max_size):
    """Map each box in `box_lists` to a feature map level index and return the
    assignment vector.
...
def assign_boxes_to_levels_max(box_lists, min_level, max_level,
                               canonical_box_size, canonical_level):
    return assign_boxes_to_levels_by_metric(box_lists,
                                            min_level,
                                            max_level,
                                            canonical_box_size,
                                            canonical_level,
...
def assign_boxes_to_levels_bezier(box_lists, min_level, max_level,
                                  canonical_box_size, canonical_level):
    return assign_boxes_to_levels_by_metric(box_lists,
                                            min_level,
                                            max_level,
...
class TopPooler(ROIPooler):
    """ROIPooler with option to assign level by max length.
