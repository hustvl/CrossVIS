...
def create_coco_semantic_from_instance(instance_json, sem_seg_root,
                                       categories):
...
if __name__ == '__main__':
    ...
    if args.dataset_name == 'coco':
        thing_id_to_contiguous_id = _get_coco_instances_meta(
    ...
    for s in ['train2017']:
        create_coco_semantic_from_instance(
            os.path.join(dataset_dir,
                         'annotations/instances_{}.json'.format(s)),
